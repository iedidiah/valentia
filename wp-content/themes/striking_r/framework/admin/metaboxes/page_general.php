	...
	public function tabs(){
		$options =  array(
			...
			array(
				...
				"options" => array(
					array(
						"name" => __("Feature Header Title & Custom Title Color",'theme_admin'),
						"desc" => __("This setting applies to both title types, and overrides the theme default color in the Color Panel/Feature Header Elements.",'theme_admin'),
					...
					array(
						...
						"desc" => __("This refers to any descriptive text content entered into the Custom Content Field in the Feature Header Settings tab.  It overrides the theme default color in the Color Panel/Feature Header Elements.",'theme_admin'),
					...
					array(
						...
						"desc" => __("If you specify a color below, this will override the theme default color in the Color Panel/Body Elements.",'theme_admin'),
