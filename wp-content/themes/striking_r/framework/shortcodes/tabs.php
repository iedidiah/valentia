...
function theme_shortcode_toggle($atts, $content = null, $code) {
	...
	return '<div class="toggle'.$align.$state.'"><h4 class="toggle_title"'.$title_size_style.'><i class="toggle_icon"'.$icon_style.'></i>' . $title . '</h4><div class="toggle_content"'.$display.'>' . do_shortcode(trim($content)) . '</div></div>';
}
