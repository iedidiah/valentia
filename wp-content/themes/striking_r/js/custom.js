    ...
    $(".portfolios").each(function() {
        ...
        if ($section.is('.sortable')) {
            ...
            var $ajax_callback = function(data) {
                ...
                $list.quicksand($temp.find('.portfolio_item'), $preferences, $callback);
            ...
            $('.sort_by_cat a', this).click(function(e) {
                ...
                if ($ajax) {
                    ...
                    if ($(this).attr('data-value') === 'all') {
                        $sorted_data = $data.find('.portfolio_item').clone();
                    } else {
                        $sorted_data = $data.find('.portfolio_item[data-cat*=' + $(this).attr('data-value') + ']').clone();
                    }
